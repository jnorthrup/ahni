...
public class NeuronConnection implements Connection {
    ...
    /**
     * Create connection with input neuron <code>anIncoming</code> and weight
     * <code>aWeight</code>.
     *
     * @param anIncoming
     * @param aWeight
    ...
    /**
     * Utility method to convert collection of connections, presumably an entire
     * ANN, to XML. XML representation is consistent with
