...
/**
 * Mutation operator that adds neurons anywhere in the network and connections
 * it with two new connections, with the outgoing connection initially having a
 * small weight value based on
 * {@link WeightMutationOperator#WEIGHT_MUTATE_STD_DEV_KEY}. Note that this
 * operator is not enabled unless the classic mutation scheme is disabled (see
 * {@link NeatConfiguration#TOPOLOGY_MUTATION_CLASSIC_KEY}).
 *
...
public class AddNeuronAnywhereMutationOperator extends MutationOperatorMultiple implements Configurable {
    ...
    /**
     * Properties key, the mutation rate. The number of neurons added is a
     * factor of this and the current number of neurons in the network.
     */
    ...
    /**
     * @see
     * AddNeuronAnywhereMutationOperator#AddNeuronAnywhereMutationOperator(double)
     */
