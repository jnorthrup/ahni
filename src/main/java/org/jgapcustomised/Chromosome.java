...
public class Chromosome extends EvaluationData implements Comparable, Serializable, Cloneable {
     ...
     * </a> speciation methodology. It is generic enough that the alleles do not
    ...
    /**
     * @param alleleToMatch
     * @return Gene gene with same innovation ID as <code>geneToMatch</code, or
     ...
     * if and the argument is an instance of the Chromosome class and has the
     * same ID.
     *
    ...
    /**
     * should only be called from Species; assigns this chromosome to
    ...
    /**
     * Checks whether this individual dominates the specified other individual,
     * i.e. it is at least as good as the other one in all objectives and for at
     * least one objective it is better (i.e. higher fitness value).
     *
     * This code is based on JNSGA2 by Joachim Melcher, Institut AIFB,
