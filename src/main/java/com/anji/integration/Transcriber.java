...
public interface Transcriber<T extends Activator> {
    ...
    /**
     * Sub-classes must implement this method to convert the genotype to a
     * phenotype.
     *
    ...
    /**
     * Sub-classes must implement this method to convert the genotype to a
     * phenotype, using an existing substrate object to allow performance gains
     * by avoiding destroying and creating large objects or arrays.
     *
     * @param c chromosome to transcribe
