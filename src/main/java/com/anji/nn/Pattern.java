...
public class Pattern {
    ...
    /**
     * Create Pattern with <code>dimension</code> inputs. This ctor should be
     * called if <code>Pattern</code> object is to manage array of values.
     *
     * @param dimension
    ...
    /**
     * Create Pattern with <code>aValues</code> as inputs. This ctor should be
     * called if caller is to manager array of values;
     *
     * @param aValues
     * @throws IllegalArgumentException
     */
    ...
    public String toXml() {
        ...
        for (int i = 0; i < values.length; ++i) {
            result.append("<value index=\"").append(i).append("\" >").append(values[i]).append("</value>\n");
        }
        result.append("</").append(XML_TAG).append(">\n");
