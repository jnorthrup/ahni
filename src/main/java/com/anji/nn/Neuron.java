...
/**
 * Neuron component of an artificial neural network. Performs an activation
 * function on a sum of inputs.
 *
...
public class Neuron implements XmlPersistable {
    ...
    /**
     * Wrapper class around neuron to include neuron values plus other data that
     * aid visualization.
     *
     * @author Philip Tucker
     */
    private static class NeuronMetaData {
        ...
        /**
         * @return boolean true if neuron's value has not been updated for
         * current time step
         */
    ...
    // time step
    private final List<Connection> incomingConns = new ArrayList<>();
    ...
    /**
     * XML representation is consistent with
    ...
    /**
     * XML representation is consistent with
     * <a href="http://nevt.sourceforge.net/">NEVT </a>. Utility method to
     * convert collection of neurons, presumably an entire ANN, to XML.
     *
     * @param allNeurons
     * @param outputNeurons
    ...
    /**
     * Calculates position in input layer based on average of position of inputs
     * connected into this neuron; i.e., if a this neuron has 2 input
     * connections from input neurons at positions 2 and 3, this neurons
     * position is 2.5.
     *
     * @param n
     * @return position of Neuron in input layer, -1 if neuron not in input
     * layer
     */
    ...
    /**
     * Constructs meta data basedon neuron's relative position to all other
     * neurons.
     *
     * @param neuron
     * @param allMetaData <code>Map</code> contains <code>Long</code> key
     * innovation ID, <code>NeuronMetaData</code> value
     * @return NeuronMetaData best-guess layout position of neuron, or null if
     * neuron is on a recursive path
     */
    ...
    /**
     * for logging, tracking, debugging; this ID usually will be the innovation
    ...
    /**
     * @return true if this neuron's value has not been updated for the current
     * time step
     */
    public boolean isDirty() {
        return dirty;
