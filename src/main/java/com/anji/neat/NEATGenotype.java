...
/**
 * Modifies JGAP Genotype to allow more flexibility in how initial population is
 * generated.
 *
...
public class NEATGenotype extends Genotype {
    ...
    /**
     * Convenience method that returns a newly constructed NEATGenotype instance
     ...
     * will be set to random legal values.<p>
    ...
    public static NEATGenotype randomInitialGenotype(Properties props, NeatConfiguration a_activeConfiguration) throws InvalidConfigurationException {
        ...
        Map<MutationOperator, Double> origMutatationRates = new HashMap<>();
        ...
        for (int i = 1; i < populationSize; i++) {
            ...
            if (props.getBooleanProperty(NeatConfiguration.INITIAL_TOPOLOGY_FULLY_CONNECTED_KEY, true)) {
                ...
                for (MutationOperator operator : a_activeConfiguration.getMutationOperators()) {
                    operator.mutate(a_activeConfiguration, material, -1, 1);
                }
        ...
        if (!props.getBooleanProperty(NeatConfiguration.INITIAL_TOPOLOGY_FULLY_CONNECTED_KEY, true)) {
            ...
            if (mutRateFactor > 1) {
                ...
                a_activeConfiguration.getMutationOperators().forEach((operator) -> {
