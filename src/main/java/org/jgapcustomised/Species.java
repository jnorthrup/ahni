...
public class Species {
    ...
    /**
     * True iff this species contains the bestPerforming individual from the
     * entire population.
     */
     ...
     * @param representativeMaterial The representative chromosome material.
     * Need not correspond to any material in actual population, it just
     * represents a point in genome space. The material is cloned.
     */
    ...
    /**
     * Create new species with given Chromosome as first member of species. The
     * material of given Chromosome is cloned and used as the (initial)
    ...
    /**
     * Sets the representative material. Need not correspond to any material in
     * actual population, it just represents a point in genome space. The
     * material is cloned.
     */
    ...
    /**
     * Add a chromosome to this species. Updates the species reference in the
     * chromosome.
     *
     * @param aChromosome
    ...
    /**
     * @param aChromosome
     * @return true if chromosome was removed, false if chromosome not a member
     * of this specie
     */
    ...
    /**
     * Move the given Chromosome from it's current species to this species. An
     * IllegalArgumentException is thrown if the chromosome is not currently in
     * a species.
     *
     * @return false if the chromosome's current species is this species,
     * otherwise true.
     */
    ...
    /**
     * Add the given Chromosome to this species, removing it from it's current
    ...
    public boolean addOrMoveFromCurrentSpecies(Chromosome c) {
        if (c.getSpecie() != null && c.getSpecie().equals(this)) {
            return false;
        }
    ...
    /**
     * Remove all chromosomes from this species. NOTE: this method does not
     * update the species field in the removed Chromosomes.
     */
    public void clear() {
        chromosomes.clear();
        bestPerforming = null;
    ...
    /**
     * Remove all chromosomes from this specie except <code>keepers</code> NOTE:
     * this method does not update the species field in the removed Chromosomes.
     *
    ...
    /**
     * update internal variables (bestPerforming, stagnantGenerationsCount) to
     ...
     * @throws IllegalArgumentException if chromosome is not a member if this
     * specie
     */
    ...
    /**
     * @return Average fitness over all chromosomes in this species. This is
     * equivalent to the sum of calling
     * {@link #getChromosomeSpeciatedFitnessValue(Chromosome)} over all
    ...
    /**
     * Determine and return the top specified proportion of chromosomes in this
     * species. The returned chromosomes are marked as being elite and all other
     * chromosomes in this species are marked as not elite.
     *
     * @param proportion The proportion of Chromosomes to select, range (0, 1).
     * @param minToSelect The minimum number of Chromosomes to select. Use 0 for
     * no minimum.
     * @param bestPerforming If not null this is the population-wide best
     * performing and should be added to the list of elites.
     ...
     * @param includeElites If true then elites will be included in the returned
     * list, otherwise elites will be ignored.
    ...
    public String toString() {
        StringBuilder result = new StringBuilder("Specie ");
        result.append(getID());
        return result.toString();
    }

    /**
     * @return String XML representation of object according to
     * <a href="http://nevt.sourceforge.net/">NEVT </a>.
     */
    public String toXml() {
    ...
    /**
     * Remove the clones from this species, as determined by
     * {@link org.jgapcustomised.Chromosome#isEquivalent(Chromosome)}.
     * @return 
     */
    public List<Chromosome> cullClones() {
        ArrayList<Chromosome> chromosomesArr = new ArrayList<>(chromosomes);
