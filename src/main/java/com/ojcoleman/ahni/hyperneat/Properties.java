...
/**
 * Extension of {@link com.anji.util.Properties} that provides some convenience
 * methods for retrieving commonly required objects and event communication
 * functionality via {@link com.ojcoleman.ahni.event.AHNIEventListener}s.
 */
public class Properties extends com.anji.util.Properties {
    ...
    /**
     * Creates a new Properties initialised with properties read from the given
     * resource.
     *
     * @throws IOException
     */
    ...
    /**
     * Set the HyperNEATEvolver that is handling this run. This method should
     * generally only be called by {@link HyperNEATEvolver}.
     */
