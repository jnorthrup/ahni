 ...
 * (<code>AnjiNet</code>) from a chromosome. <code>TranscriberFactory</code>
 * should be used to construct an <code>AnjiNetTranscriber</code>, given a
 * chromosome. <code>getNet()</code> or <code>getPhenotype()</code> returns the
 * resulting network.
 *
...
public class AnjiNetTranscriber implements Transcriber<AnjiActivator>, Configurable {
            ...
            throws TranscriberException 
    {
        ...
        inNeuronAlleles.values().forEach((neuronAllele) -> {
